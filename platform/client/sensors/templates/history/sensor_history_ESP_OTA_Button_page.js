Template.sensor_history_ESP_OTA_Button_page.events({});

Template.sensor_history_ESP_OTA_Button_page.helpers({
    'ESP_OTA_Button_table': function () {
        return {
            ...
            fields: [
                ...
                {
                    key: 'message.d.Result', label: 'Result', fn: function (value, object, key) {
                    var is_ok = value.indexOf("OK") !== -1;

                    if (is_ok) {
                        buf = "<span class='label label-success'>" + value + "</span>";
                    } else {
                        buf = "<span class='label label-danger>" + value + "</span>";
                    }
